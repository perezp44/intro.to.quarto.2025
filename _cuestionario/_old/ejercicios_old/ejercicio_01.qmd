...
Por mucho que me empeñe yo, $y_{t}=A_{1}y_{t-1}+A_{2}y_{t-2}+v_{t}$ no es la ecuación de la Curva de Philips. Tampoco esta:
...
Nos falta hacer una tabla, así que:
