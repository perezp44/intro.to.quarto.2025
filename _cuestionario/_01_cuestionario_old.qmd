...
## 4. Web/Blog con Quarto

### 4.A (Web básica)

------------------------------------------------------------------------

Vamos a crear una web básica para mostrar al mundo nuestros hallazgos sobre Eurovision. Abajo tienes las instrucciones
...
Si tenemos tiempo podemos tratar de hacer algunos de los "ejercicios" de las [Slides 06: Más cosas con Quarto](../slides/06_mas_cosas.qmd){target="_blank"}


Por ejemplo, podemos tratar de hacer:
