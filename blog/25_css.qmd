...
image: thumbnails/thumbnail_25_css.png
description: |
  Cambiando el formato con CSS
css: ["assets/post_25_01.css" , "assets/post_25_02.css"]
#css: "assets/mis_estilos_01.css"
---
...
Si quieres ver como quedaría este mismo post pero utilizando las reglas CSS (bizarras) que puedes ver abajo, puedes hacerlo [aquí](/posts/post_06_css-bizarro.html). Ya os digo que los cambios son un poco raros, vamos no muy estéticos.
