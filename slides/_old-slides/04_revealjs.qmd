...
## Imágenes: con Stretch {.r-stretch}

Hace que se ajuste al espacio vertical que queda en la slide. Es la opción por defecto. Puedes desactivarla. Documentación [aquí](https://quarto.org/docs/presentations/revealjs/advanced.html#stretch)

```rmarkdown
![](imagenes/imagen_ababol.jpg){.r-stretch}
```
...
- {{< kbd CTRL-SHIFT-F >}} : permite **buscar palabras** dentro de las slides. Dando a {{< kbd ENTER >}} avanzas a la siguiente coincidencia. Además, Si lo haces cuando mientras las slides están en overview te marcará todas las coincidencias
...
- [Speak view](https://quarto.org/docs/presentations/revealjs/#speaker-notes)

- [Revealjs Plugins](https://quarto.org/docs/presentations/revealjs/advanced.html#reveal-plugins). Por ejemplo: Multiplex, 

<https://quarto.org/docs/reference/formats/presentations/revealjs.html#slide-tools>
